...
<div class="row">
    ...
    <div class="column-responsive column-80">
        <div class="users view content">
            ...
            <div class="related">
                <h4><?= __('Related Desks') ?></h4>
                <?php if (!empty($user->desks)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($user->desks as $desks) : ?>
                        <tr>
                            <td><?= h($desks->id) ?></td>
                            <td><?= h($desks->user_id) ?></td>
                            <td><?= h($desks->available) ?></td>
                            <td><?= h($desks->ordered) ?></td>
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Desks', 'action' => 'view', $desks->id]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Desks', 'action' => 'edit', $desks->id]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Desks', 'action' => 'delete', $desks->id], ['confirm' => __('Are you sure you want to delete # {0}?', $desks->id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
