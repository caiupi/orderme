...
<nav>
    <h3 style="text-align:center">
        <?= $this->Html->link('Usersss',['controller'=>'users','action'=>'index']) ?> |
        <?= $this->Html->link('Carts',['controller'=>'carts','action'=>'index']) ?> |
        <?= $this->Html->link('Orders',['controller'=>'orders','action'=>'index']) ?> |
        <?= $this->Html->link('Dishs',['controller'=>'dishs','action'=>'index']) ?> |
        <?= $this->Html->link('Desks',['controller'=>'desks','action'=>'index']) ?> </h3>
</nav>
<main class="main">
    <div class="container">
        <div class="content">
